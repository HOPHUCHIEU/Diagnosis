  ...
  const renderFollowUpAppointmentCard = (followUpAppointment: Appointment, index: number) => {
    ...
    return (
      <div key={followUpApptId} className='p-4 mb-4'>
              ...
              <div className='space-y-2'>
                ...
                {followUpAppointment.isVideoCallEnded ? (
                  ...
                  <div className='p-3 text-blue-700 bg-blue-50 rounded-md border border-blue-200'>
                    <p className='flex items-center'>
                      <Video className='mr-2 w-5 h-5 text-blue-500' />
        ...
        {followUpAppointment.status === 'confirmed' && followUpAppointment.type === 'in_person' && (
          <div className='p-4 mt-3 bg-amber-50 rounded-lg border border-amber-200'>
            <div className='flex items-start'>
              <Clipboard className='mr-3 w-5 h-5 text-amber-500 mt-0.5' />
              <div>
        ...
        {followUpAppointment.status === 'completed' && followUpAppointment.medicalInfo && (
          <div className='mt-3'>
            <AccordionItem
              ...
              className='mb-3 bg-white rounded-lg border border-green-200 shadow-sm'
            >
  ...
  return (
    <div className='mt-6 space-y-6'>
      <Dialog>
        ...
        <div className='p-4 bg-white rounded-lg border border-gray-100 shadow-sm'>
          <div className='flex gap-4 items-center'>
            <div className='flex justify-center items-center w-14 h-14 text-green-600 bg-green-100 rounded-full'>
              <Stethoscope size={24} />
            </div>
            <div>
              <h3 className='text-lg font-medium'>
        ...
        {pendingMedicalInfo && !showMedicalForm && (
          <div className='p-4 bg-amber-50 rounded-lg border border-amber-200'>
            ...
            <DialogTrigger asChild>
              <Button onClick={() => setShowMedicalForm(true)} className='bg-amber-600 hover:bg-amber-700'>
                <Edit className='mr-2 w-4 h-4' /> Cập nhật thông tin y tế
              </Button>
            </DialogTrigger>
          </div>
        )}

        {/* Form cập nhật thông tin y tế cho bệnh nhân */}
        {showMedicalForm && (
          <DialogContent>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex gap-2 justify-end mt-4'>
                <Button variant='outline' onClick={() => setShowMedicalForm(false)}>
                  Hủy
                </Button>
